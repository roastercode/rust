...
fn main() {
    ...
    // `colorr` and stores the borrow and closure in the `print`
    ...
    // `consume` consume the variable so this can only be called once.
    consume();
    //consume();
    // ^ TODO: Try uncommenting this line.
}
